...
public class CardSelector {
    ...
    public static final CardSelector HIPERCARD = new CardSelector(R.drawable.card_color_round_rect_light, true, R.drawable.chip_yellow, R.drawable.chip_yellow_inner, R.drawable.ic_billing_hipercard_logo, CardSelector.CVV_LENGHT_DEFAULT);
    ...
    public static final CardSelector CREDISHOP = new CardSelector(R.drawable.card_color_round_rect_light, true, R.drawable.chip_yellow, R.drawable.chip_yellow_inner, R.drawable.ic_billing_credishop_logo, CardSelector.CVV_LENGHT_DEFAULT);
    public static final CardSelector MASTER = new CardSelector(R.drawable.card_color_round_rect_light, true, R.drawable.chip_yellow, R.drawable.chip_yellow_inner, R.drawable.ic_billing_mastercard_logo, CardSelector.CVV_LENGHT_DEFAULT);
